 ...
 *!!!!!! NOTICE !!!!!!
 *
 * Modified by Niklas Weissner for Mesopotamia Tigris
 * 
 * 16.03.2014
 * 	Removed font style information from gauge. Seriously. Don't tell me what font to use!
 */
...
if (this.config.showGaugeShadow == true)
{
	...
	if (this.config.title && this.config.title != "")
	{
		...
		this.gaugeTIT.setAttributeNS(null, 'style',  "fill-opacity:1.0; fill:" + this.config.titleColor + "; text-anchor:middle;");
	...
	if (this.config.label && this.config.label != "")
	{
		...
		this.gaugeLBL.setAttributeNS(null, 'style',  "font-weight:normal; fill-opacity:1.0; fill:" + this.config.labelColor + "; text-anchor:middle;");
	...
	this.gaugeVAL.setAttributeNS(null, 'style',  "fill-opacity:1.0; fill:" + this.config.valueColor + "; text-anchor:middle;"); //Changed here
